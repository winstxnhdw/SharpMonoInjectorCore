...
static class Core {
    static void Inject(string targetProcess, FileInfo assembly, string loaderNamespace, string loaderClass, string loaderMethod) {
        using Injector injector = new Injector(targetProcess);
    ...
    static void Eject(string targetProcess, IntPtr assemblyAddress, string loaderNamespace, string loaderClass, string loaderMethod) {
        using Injector injector = new Injector(targetProcess);
    ...
    static void Main(string[] args) {
        ...
        Command injectCommand = new Command("inject", "Injects a managed assembly into a process");
        Command ejectCommand = new Command("eject", "Ejects a managed assembly from a process");
        ...
        Option<string> loaderClass = OptionHelper.CreateOption<string>(
            name: "--class",
            alias: "-c",
        ...
        Option<string> loaderMethod = OptionHelper.CreateOption<string>(
            name: "--method",
            alias: "-m",
        ...
        injectCommand.SetHandler(
            (string targetProcess, FileInfo assembly, string loaderNamespace, string loaderClass, string loaderMethod)
                => Inject(targetProcess, assembly, loaderNamespace, loaderClass, loaderMethod),
                targetProcess, assembly, loaderNamespace, loaderClass, loaderMethod
        );

        ejectCommand.SetHandler(
            (string targetProcess, IntPtr assemblyAddress, string loaderNamespace, string loaderClass, string loaderMethod)
                => Eject(targetProcess, assemblyAddress, loaderNamespace, loaderClass, loaderMethod),
                targetProcess, assemblyAddress, loaderNamespace, loaderClass, loaderMethod
        );
